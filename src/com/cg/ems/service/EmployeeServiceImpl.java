...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	@Override
	public List<Employee> viewEmployeeByDeptName(String deptName) throws EMSException {
		employeeDao = new EmployeeDaoImpl();
	...
	@Override
	public List<Employee> viewEmployeeByMaritalStatus(String maritalStatus) throws EMSException {
		employeeDao = new EmployeeDaoImpl();
		List<Employee> employeeList = null;
	...
	public List<Employee> viewEmployeeByWildCard(String searchString) throws EMSException {
		...
		employeeDao = new EmployeeDaoImpl();
		List<Employee> employeeList = null;
		employeeList = employeeDao.viewEmployeeByWildCard(searchString);
		return employeeList;
	}
